...
}
{
  ...
  console.log(`berths: ${ports.length - short.length}/${ports.length} reach the ` +
    `${(CFG.berthClearanceCells * CFG.grid.cell * 60).toFixed(1)} nm target` +
...
/* GENERATED by tools/build_terrain.mjs — do not edit by hand.
   ...
   real coordinates, targeting ${+(CFG.berthClearanceCells * CFG.grid.cell * 60).toFixed(1)} nm clear of the beach so the whole
